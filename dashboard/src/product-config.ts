...
export const RECORDS_LABEL = 'Verifications'           // sidebar + page heading: 'Contracts', 'Claims', 'Invoices'
export const RECORDS_SUBTITLE = 'Patient insurance eligibility and benefits verifications.'  // page subtitle
export const FILTER_PLACEHOLDER = 'Filter by carrier or member ID...'  // search box placeholder
